...
function Form( { setShowMatchCard, setAccFound, setShowMatch, setMatchData, setRankData, setShowCard, setLoadShowCard }){
    ...
    return(
        <div className="animate-fade-in-down text-center border-background border bg-black/30 backdrop-brightness-80 backdrop-blur-[3px] text-text font-bold shadow-[0_0_80px_10px_#111823] p-8 rounded-2xl h-full ">
            <p className="text-2xl md:text-4xl lg:text-5xl mb-2">Username</p>
            ...
            <p className="text-2xl md:text-4xl lg:text-5xl mb-2">Tag</p>
            ...
            <p className="text-2xl md:text-4xl lg:text-5xl mb-2">Region</p>
            <select className="text-1xl md:text-2xl border-2 text-center border-background text-white rounded-md w-3/4 h-1/10 mb-8" onChange={handleRegionChange}>
